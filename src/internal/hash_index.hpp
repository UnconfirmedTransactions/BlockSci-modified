...
namespace blocksci {
    ...
    public:
        ...
        /** Get the scriptNum for the given taproot hash */
        ranges::optional<uint32_t> getTaprootHashIndex(const uint256 &taproothash);
    ...
    extern template ranges::any_view<std::pair<uint32_t, typename blocksci::AddressInfo<AddressType::WITNESS_TAPROOTHASH>::IDType>> HashIndex::getAddressRange<AddressType::WITNESS_TAPROOTHASH>();
