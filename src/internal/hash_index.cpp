...
namespace blocksci {
    ...
    ranges::optional<uint32_t> HashIndex::getTaprootHashIndex(const uint256 &taproothash) {
        return lookupAddress<AddressType::WITNESS_TAPROOTHASH>(taproothash);
    }
    ...
    template ranges::any_view<std::pair<uint32_t, typename blocksci::AddressInfo<AddressType::WITNESS_TAPROOTHASH>::IDType>> HashIndex::getAddressRange<AddressType::WITNESS_TAPROOTHASH>();
