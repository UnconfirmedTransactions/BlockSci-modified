...
void init_witness_taproothash(py::class_<script::WitnessTaprootHash> &cl) {
    
    cl
    .def("__repr__", &script::WitnessTaprootHash::toString)
    .def("__str__", &script::WitnessTaprootHash::toPrettyString)
    ;
}
...
void addWitnessTaprootHashRangeMethods(RangeClasses<script::WitnessTaprootHash> &classes) {
	addAllRangeMethods(classes);
}
