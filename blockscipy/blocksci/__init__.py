...
setup_self_methods(WitnessTaprootHashAddress)
...
setup_iterator_and_proxy_methods(WitnessTaprootHashAddressIterator)
...
setup_range_and_proxy_methods(WitnessTaprootHashAddressRange)
