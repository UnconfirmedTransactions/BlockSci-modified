...
template <>
struct ScriptOutputData<blocksci::AddressType::Enum::WITNESS_TAPROOTHASH> : public ScriptOutputDataBase {
    static constexpr bool maybeUpdate = true;
...
public:
    ...
    AnyScriptOutput(const blocksci::CScriptView &scriptPubKey, bool p2shActivated, bool witnessActivated, bool taprootActivated);
