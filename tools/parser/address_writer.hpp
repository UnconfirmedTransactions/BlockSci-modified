...
class AddressWriter {
    ...
    void serializeInputImp(const ScriptInput<blocksci::AddressType::WITNESS_TAPROOTHASH> &input, ScriptFile<blocksci::DedupAddressType::SCRIPTHASH> &file);
    ...
    void serializeOutputImp(const ScriptOutput<blocksci::AddressType::WITNESS_TAPROOTHASH> &output, ScriptFile<blocksci::DedupAddressType::SCRIPTHASH> &file, bool topLevel);    
    ...
    void serializeWrappedScript(const ScriptInputData<blocksci::AddressType::Enum::WITNESS_TAPROOTHASH> &input, uint32_t txNum, uint32_t outputTxNum);
